...
def test_objects_get(extended_model: ExtendedModel, database: MiniLiteDb):
...
def test_objects_filter(extended_model: ExtendedModel, database: MiniLiteDb):
    database.add_model(extended_model)
    database.clean_tables()
...
def test_objects_all(extended_model: ExtendedModel, database: MiniLiteDb):
    database.add_model(extended_model)
    database.clean_tables()
...
def test_objects_check_unique_together(extended_model: ExtendedModel, mini_model: MiniModel, database: MiniLiteDb):
    database.add_model(extended_model)
    ...
    is_creating_check = extended_model.objects.check_unique_together(is_creating=True, name="extended",
                                                                     last_name="model")
    assert is_creating_check is False
    is_creating_check_false = extended_model.objects.check_unique_together(is_creating=True, name="extended",
                                                                           last_name="model2")
    ...
    update_check_with_object = extended_model.objects.check_unique_together(name="extended", last_name="model",
                                                                            object_id=extended.id)
    assert update_check_with_object is True


def test_objects_update(extended_model: ExtendedModel, database: MiniLiteDb):
    database.add_model(extended_model)
    database.clean_tables()
...
def test_objects_create(extended_model: ExtendedModel, database: MiniLiteDb):
    database.add_model(extended_model)
    database.clean_tables()
...
def test_objects_delete(extended_model: ExtendedModel, database: MiniLiteDb):
    database.add_model(extended_model)
    database.clean_tables()
